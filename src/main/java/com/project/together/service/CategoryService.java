...
public class CategoryService {
    ...
    public void createCategory() {
        ...
        //category.setCategoryName(CategoryList.인기상품);
        category.setCategoryName("인기상품");
        categoryRepository.save(category);

        Category category2 = new Category();
        //category2.setCategoryName(CategoryList.디지털기기);
        category2.setCategoryName("디지털기기");
        categoryRepository.save(category2);

        Category category3 = new Category();
        //category3.setCategoryName(CategoryList.가구인테리어);
        category3.setCategoryName("가구/인테리어");
        categoryRepository.save(category3);

        Category category4 = new Category();
        //category4.setCategoryName(CategoryList.스포츠레저);
        category4.setCategoryName("스포츠/레저");
        categoryRepository.save(category4);

        Category category5 = new Category();
        //category5.setCategoryName(CategoryList.의류잡화);
        category5.setCategoryName("의류/잡화");
        categoryRepository.save(category5);

        Category category6 = new Category();
        //category6.setCategoryName(CategoryList.게임취미);
        category6.setCategoryName("게임/취미");
        categoryRepository.save(category6);

        Category category7 = new Category();
        //category7.setCategoryName(CategoryList.도서티켓음반);
        category7.setCategoryName("도서/티켓/음반");
        categoryRepository.save(category7);

        Category category8 = new Category();
        //category8.setCategoryName(CategoryList.모바일상품권);
        category8.setCategoryName("모바일상품권");
        categoryRepository.save(category8);

        Category category9 = new Category();
        //category9.setCategoryName(CategoryList.기타중고물품);
